package pl.zgora.uz.indoorloc.trilateration;
...
public class NonLinearLeastSquaresSolver {
	...
	protected final static int MAXNUMBEROFITERATIONS = 100;

	public NonLinearLeastSquaresSolver(TrilaterationFunction func, LeastSquaresOptimizer leastSquaresOptimizer) {
		function = func;
